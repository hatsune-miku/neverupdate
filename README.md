...
NeverUpdate 会自我提权为 `TrustedInstaller`，并进行破坏系统组件的操作。使用 NeverUpdate 则代表您知晓对系统组件引入破坏性操作的风险，并愿意承担由此带来的全部后果（包括短期影响和长期潜在影响），且同意如果出现任何问题，均与开发者无关。
...
Windows 更新“一刀切”的更新策略，曾经坑惨过无数用户。Windows Update 团队显然没有意识到 BIOS 固件这种东西是什么概念，对普通人而言，这绝非一个应该频繁更新的东西。
