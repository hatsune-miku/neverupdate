# NeverUpdate — Technical Reference

## 概述

NeverUpdate 是一个 Windows 11 平台专用的系统更新阻断工具。它通过多层防御机制（服务注册表篡改、hosts/防火墙规则、组策略、计划任务 XML 补丁、兜底注册表设置）持续阻止 Windows Update 的自动下载与安装，并提供一个 Tauri 桌面 GUI 和一个以 Windows 服务形式运行的守护进程来保障阻断状态的持久性。

---

## 系统架构

<p align="center"><img src="assets/architecture.svg" alt="System Architecture" /></p>
...
<p align="center"><img src="assets/guard-trait.svg" alt="Guard Trait" /></p>
...
<p align="center"><img src="assets/guard-action-sequence.svg" alt="Guard Action Sequence" /></p>
...
<p align="center"><img src="assets/ti-acquisition.svg" alt="TI Token Acquisition" /></p>
...
<p align="center"><img src="assets/daemon-scm-lifecycle.svg" alt="Daemon SCM Lifecycle" /></p>
...
<p align="center"><img src="assets/daemon-cycle.svg" alt="Daemon Maintenance Cycle" /></p>
